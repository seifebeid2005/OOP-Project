...
public class Chapter {
    ...
    public Chapter(int lessonId, String lessonTitle, String lessonDescription, int levelId, int duration, String language, String lessonType, int tutorId, int Grade) {
