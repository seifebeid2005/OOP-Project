public class lesson {
    ...
    public lesson(int lesson_id, String lesson_title, String lesson_description, int level_id, int duration, String language, String lesson_type, int tutor_id) {
    ...
    public void remove_material(String material) {
        ...
        for (int i = 0; i < material_array.length; i++) {
            if (!material_array[i].equals(material)) {
                if (!temp.isEmpty()) {
                    temp += ", ";
                }
                temp += material_array[i];
            }
        }
    ...
    public String toString() {
        return   "lesson ID:" + lesson_id +", lesson Title:" + lesson_title + ", lesson Description:" + lesson_description + ", level ID:" + level_id+", duration:" + duration +", languag:" + language  + ", lesson Type:" + lesson_type + ", tutor ID:" + tutor_id +", materials:" + materials ;
